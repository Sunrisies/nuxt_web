        ...
        >
          <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
            <div class="flex items-center gap-2">
              <UBadge color="blue" variant="outline">{{ note.category?.name }}</UBadge>
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-3 line-clamp-2">{{ note.description }}</p>
...
const formatChineseDateTime = (dateString) => {
  // 这里使用您的 sunrise-utils 或其他格式化方法
  // 如果没有，可以使用以下简单格式化
